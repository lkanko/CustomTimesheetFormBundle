...
use App\Controller\TimesheetController as TimesheetBaseTeamController;
use App\Entity\Tag;
use App\Entity\Team;
...
use KimaiPlugin\CustomTimesheetFormBundle\Form\TimesheetAdminEditForm;
use KimaiPlugin\CustomTimesheetFormBundle\Form\TimesheetMultiUserEditForm;
 ...
 */
class TimesheetTeamController extends TimesheetBaseTeamController
{
    /**
    ...
    {
        return $this->edit($entry, $request, '@CustomTimesheetForm/timesheet-team/edit.html.twig');
    }
    ...
    {
        return $this->duplicate($entry, $request, '@CustomTimesheetForm/timesheet-team/edit.html.twig');
    }
    ...
    {
        return $this->create($request, '@CustomTimesheetForm/timesheet-team/edit.html.twig', $projectRepository, $activityRepository, $tagRepository);
    }
